      ...
      <main className='platonism container'>
        <section className='platon_school'>
          <div className="palton_text_box">
            ...
            <p className='platon_text_def '><span className='greece gold'>Stoicism  </span>is a philosophical school that teaches the pursuit of virtue and inner peace through self-control, reason, and acceptance of what cannot be changed. Stoics emphasize focusing on one’s own thoughts and actions rather than external events that are beyond one's control.</p>
            <div className="platon_button_father">
              {/* <button className='platon_button'><Link className='link1' to={"/Platonism"}>MORE</Link></button> */}
            </div>
          </div>
          <div className="stoic_main"></div>
        </section>
        ...
        <div className="main_history">
          ...
          <div className="stoic_his_img"></div>
        </div>
        <div className="main_quotes1">
          <div className="quote_img2 quote"></div>
