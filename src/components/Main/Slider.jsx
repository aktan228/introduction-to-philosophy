      ...
      <div className="aristotel" style="width: 100%; display: none;">
        <div className="jcsb">
          ...
          <div className="slider_text_box">
            ...
            <Link to={"/Aristotelianism"}><button className="slider_button gold"><p>MORE</p></button></Link>
      ...
      <div className="piron">
        <div className="jcsb">
          ...
          <div className="slider_text_box">
            ...
            <Link to={"/Skepticism"}> <button className="slider_button gold"><p>MORE</p></button></Link>
          </div>
        </div>
      </div>
      <div className="platon">
        <div className="jcsb">
          ...
          <div className="slider_text_box">
            ...
            <Link to={"/Platonism"}><button className="slider_button gold"><p>MORE</p></button></Link>
            </div>
        </div>
      </div>
      <div className="epicur">
        <div className="jcsb">
          ...
          <div className="slider_text_box">
            ...
            <Link to={'/Epicureanism'}><button className="slider_button gold"><p>MORE</p></button></Link>
            </div>
        </div>
      </div>
      <div className="zenon">
        <div className="jcsb">
          ...
          <div className="slider_text_box">
            ...
            <Link to={'/Stoicism'}><button className="slider_button gold"><p>MORE</p></button></Link>
            </div>
        </div>
      </div>
    </Slider>
